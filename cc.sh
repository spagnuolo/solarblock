...
peer lifecycle chaincode approveformyorg --orderer localhost:7050 --ordererTLSHostnameOverride orderer.example.com --channelID publicChannel --name energycontract -v $CC_VERSION --package-id $PACKAGE_ID --sequence $CC_VERSION --tls --cafile $ORDERER_CA
