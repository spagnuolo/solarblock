 ...
 * 4. Construct request to transfer solar energy
...
async function main() {
    ...
    try {
        ...
        console.log('Submit solar energy transfer transaction.');
        ...
        console.log(`solar energy issued by ${paper.issuer}  : ${paper.eneryNumber} was successfully transferred`);
