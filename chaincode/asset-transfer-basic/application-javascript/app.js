...
async function main() {
	try {
		...
		try {
			...
			result = await contract.submitTransaction('CreateAsset', 'asset5', 'OrgKunde', 'transfered', '650kWh');
			...
			await contract.submitTransaction('UpdateAsset', 'asset5', 'OrgKunde', 'being sold', '800kWh');
			console.log('*** Result: committed');
			...
			try {
				...
				await contract.submitTransaction('UpdateAsset', 'asset50', 'OrgKunde', 'being sold', '8000kWh');
