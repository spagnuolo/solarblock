...
async function main() {
	try {
		...
		try {
			...
			console.log('\n--> Submit Transaction: CreateAsset, creates new asset with ID, Owner, Status, and amount of Kilowattstunde');
			result = await contract.submitTransaction('CreateAsset', 'asset5', 'OrgHaushaltA', 'transfered', '650kWh');
			...
			result = await contract.evaluateTransaction('AssetExists', 'asset5');
			console.log(`*** Result: ${prettyJSONString(result.toString())}`);

			console.log('\n--> Submit Transaction: UpdateAsset asset1, change the appraisedValue to 350');
			await contract.submitTransaction('UpdateAsset', 'asset5', 'OrgHaushaltA', 'being sold', '800kWh');
			console.log('*** Result: committed');
			...
			try {
				...
				await contract.submitTransaction('UpdateAsset', 'asset50', 'OrgHaushaltA', 'being sold', '8000kWh');
			...
			await contract.submitTransaction('TransferAsset', 'asset5', 'OrgNetzbetreiber');
			console.log('*** Result: committed');
