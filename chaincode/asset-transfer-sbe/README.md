...
```
{"ID":"asset1","Value":200,"Owner":"Org2User1","OwnerOrg":"OrgHaushaltAMSP"}
```
...
```
{"ID":"asset1","Value":300,"Owner":"Org2User1","OwnerOrg":"OrgHaushaltAMSP"}
```
