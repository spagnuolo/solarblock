...
setGlobals() {
  ...
  if [ $ORG -eq 1 ]; then
    ...
    CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/orgHaushaltB.example.com/users/Admin@orgHaushaltB.example.com/msp
    CORE_PEER_ADDRESS=peer0.orgHaushaltB.example.com:11251
  else
